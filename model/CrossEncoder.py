...
def fit_cross_encoder(model_name, train_loader, valid_set, y_valid, test_set, epochs=1, learning_rate=2e-5, weight_decay=0.01, classifier_dropout=None, device='cpu'):
